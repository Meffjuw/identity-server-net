CREATE TABLE "ApiResources" (
    "Id" INTEGER NOT NULL IDENTITY CONSTRAINT "PK_ApiResources" PRIMARY KEY,
...
CREATE TABLE "ApiScopes" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ApiScopes" PRIMARY KEY IDENTITY,
    "Enabled" INTEGER NOT NULL,
    "Name" NVARCHAR(50) NOT NULL,
    "DisplayName" TEXT NULL,
    "Description" TEXT NULL,
...
CREATE TABLE "Clients" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_Clients" PRIMARY KEY IDENTITY,
    "Enabled" INTEGER NOT NULL,
...
CREATE TABLE "IdentityResources" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_IdentityResources" PRIMARY KEY IDENTITY,
    "Enabled" INTEGER NOT NULL,
    "Name" NVARCHAR(50) NOT NULL,
    "DisplayName" TEXT NULL,
    "Description" TEXT NULL,
...
CREATE TABLE "ApiResourceClaims" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ApiResourceClaims" PRIMARY KEY IDENTITY,
    "Type" TEXT NOT NULL,
...
CREATE TABLE "ApiResourceProperties" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ApiResourceProperties" PRIMARY KEY IDENTITY,
    "Key" TEXT NOT NULL,
    "Value" TEXT NOT NULL,
    "ApiResourceId" INTEGER NOT NULL,
...
CREATE TABLE "ApiResourceScopes" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ApiResourceScopes" PRIMARY KEY IDENTITY,
    "Scope" TEXT NOT NULL,
    "ApiResourceId" INTEGER NOT NULL,
...
CREATE TABLE "ApiResourceSecrets" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ApiResourceSecrets" PRIMARY KEY IDENTITY,
    "Description" TEXT NULL,
    "Value" TEXT NOT NULL,
...
CREATE TABLE "ApiScopeClaims" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ApiScopeClaims" PRIMARY KEY IDENTITY,
    "Type" TEXT NOT NULL,
...
CREATE TABLE "ApiScopeProperties" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ApiScopeProperties" PRIMARY KEY IDENTITY,
    "Key" TEXT NOT NULL,
    "Value" TEXT NOT NULL,
    "ScopeId" INTEGER NOT NULL,
...
CREATE TABLE "ClientClaims" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ClientClaims" PRIMARY KEY IDENTITY,
    "Type" TEXT NOT NULL,
    "Value" TEXT NOT NULL,
...
CREATE TABLE "ClientCorsOrigins" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ClientCorsOrigins" PRIMARY KEY IDENTITY,
...
CREATE TABLE "ClientGrantTypes" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ClientGrantTypes" PRIMARY KEY IDENTITY,
...
CREATE TABLE "ClientIdPRestrictions" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ClientIdPRestrictions" PRIMARY KEY IDENTITY,
...
CREATE TABLE "ClientPostLogoutRedirectUris" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ClientPostLogoutRedirectUris" PRIMARY KEY IDENTITY,
...
CREATE TABLE "ClientProperties" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ClientProperties" PRIMARY KEY IDENTITY,
    "Key" TEXT NOT NULL,
    "Value" TEXT NOT NULL,
    "ClientId" INTEGER NOT NULL,
...
CREATE TABLE "ClientRedirectUris" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ClientRedirectUris" PRIMARY KEY IDENTITY,
...
CREATE TABLE "ClientScopes" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ClientScopes" PRIMARY KEY IDENTITY,
    "Scope" TEXT NOT NULL,
    "ClientId" INTEGER NOT NULL,
...
CREATE TABLE "ClientSecrets" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_ClientSecrets" PRIMARY KEY IDENTITY,
    "Description" TEXT NULL,
    "Value" TEXT NOT NULL,
    "Expiration" TEXT NULL,
    "Type" TEXT NOT NULL,
...
CREATE TABLE "IdentityResourceClaims" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_IdentityResourceClaims" PRIMARY KEY IDENTITY,
    "Type" TEXT NOT NULL,
...
CREATE TABLE "IdentityResourceProperties" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_IdentityResourceProperties" PRIMARY KEY IDENTITY,
    "Key" TEXT NOT NULL,
    "Value" TEXT NOT NULL,
    "IdentityResourceId" INTEGER NOT NULL,
